    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-8 pb-20">
      <div className="max-w-[900px] mx-auto w-full">
        <header className="mb-12 md:hidden">
          <h1 className="text-[24px] font-semibold text-[#121c2a] tracking-tight">Tải lên Tài liệu</h1>
        </header>
        <header className="mb-12 hidden md:block">
          <h1 className="text-[32px] font-semibold text-[#121c2a] tracking-tight">Tải lên Tài liệu</h1>
        </header>
        ...
        <div className="bg-white/70 backdrop-blur-2xl border border-white/50 rounded-[24px] p-6 md:p-12 shadow-[0_10px_40px_rgba(31,41,55,0.04)] mb-12 relative overflow-hidden">
          ...
          <div className="border-2 border-dashed border-[#c2c6d5] hover:border-[#0058be]/50 bg-[#f8f9ff] rounded-xl p-12 flex flex-col items-center justify-center text-center transition-all duration-300 group cursor-pointer h-64 mb-6">
            ...
            <h3 className="text-[24px] font-semibold text-[#121c2a] mb-1">Kéo &amp; thả tệp của bạn vào đây</h3>
            <p className="text-[16px] text-[#424753] mb-6">hoặc nhấp để chọn từ máy tính</p>
            <p className="text-[12px] font-medium text-[#727784] uppercase tracking-wider">Định dạng hỗ trợ: PDF, DOCX (Tối đa 50MB)</p>
        ...
        <div className="bg-[#eff3ff] border border-[#0058be]/20 rounded-lg p-3 flex items-center justify-between mb-12 animate-fade-in-up">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[14px] text-[#121c2a]">Chúng tôi đã tự động trích xuất siêu dữ liệu từ tệp PDF của bạn.</span>
          </div>
          <button className="text-[14px] font-semibold text-[#0058be] hover:text-[#0051d6] transition-colors">Xem lại</button>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-2xl border border-white/50 rounded-[24px] p-6 md:p-12 shadow-[0_10px_40px_rgba(31,41,55,0.04)] mb-20">
          <h2 className="text-[24px] font-semibold text-[#121c2a] mb-6">Siêu dữ liệu Tài liệu</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            {/* Title */}
            <div className="md:col-span-2">
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Tiêu đề</label>
            ...
            {/* Authors */}
            <div>
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Tác giả</label>
              <div className="min-h-[48px] p-1 border border-[#c2c6d5] bg-[#f8f9ff] rounded-lg flex flex-wrap gap-1 items-center focus-within:border-[#0058be] focus-within:ring-1 focus-within:ring-[#0058be] transition-all">
                ...
                <input className="flex-1 min-w-[100px] border-none bg-transparent h-8 text-[14px] focus:ring-0 px-1 outline-none" placeholder="Thêm tác giả..." type="text" />
              </div>
            </div>

            {/* Year */}
            <div>
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Năm</label>
            ...
            {/* Collection */}
            <div>
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Bộ sưu tập</label>
              <div className="relative">
                <select className="w-full h-12 px-3 rounded-lg border border-[#c2c6d5] bg-[#f8f9ff] focus:border-[#0058be] focus:ring-1 focus:ring-[#0058be] text-[14px] text-[#121c2a] appearance-none transition-all outline-none" defaultValue="Machine Learning">
                  ...
                  <option value="Thesis Research">Nghiên cứu luận án</option>
                  <option value="Machine Learning">Học máy</option>
                  <option value="Neuroscience">Khoa học thần kinh</option>
                </select>
            ...
            {/* Tags */}
            <div>
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Thẻ</label>
              <div className="min-h-[48px] p-1 border border-[#c2c6d5] bg-[#f8f9ff] rounded-lg flex flex-wrap gap-1 items-center focus-within:border-[#0058be] focus-within:ring-1 focus-within:ring-[#0058be] transition-all">
                ...
                <input className="flex-1 min-w-[100px] border-none bg-transparent h-8 text-[14px] focus:ring-0 px-1 outline-none" placeholder="Thêm thẻ..." type="text" />
              </div>
            </div>

            {/* Abstract */}
            <div className="md:col-span-2">
              <label className="block text-[14px] font-semibold tracking-wide text-[#121c2a] mb-1">Tóm tắt / Ghi chú</label>
